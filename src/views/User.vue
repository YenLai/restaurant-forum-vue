    ...
    <div class="container">
      <div class="card mb-3">
        ...
        <UserProfileCard
          ...
          @after-handel-followship="handleFollowship"
        />
      </div>
      <div class="row">
        <div class="col-md-4">
        ...
        <div class="col-md-8">
          <!-- UserCommentsCard -->
          <UserCommentsCard :commetRestaurants="profile.Comments" />
          <br />
...
export default {
  ...
  methods: {
    ...
    handleFollowship(isFollowed) {
      return (this.isFollowed = !isFollowed);
    },
  },
};
</script>